            ...
            if (msg) {
              ...
              if (reg) {
                ...
                prefill = {
                  ...
                  parentLien: p.parent_lien || p.lien_parente || "",
                ...
                prefill = {
                  ...
                  tailleHaut: p.uniform_top_size || p.taille_haut || p.taille_maillot || p.tailleMaillot || p.tailleHaut || "",
                  tailleShort: p.uniform_short_size || p.taille_short || p.tailleShort || "",
