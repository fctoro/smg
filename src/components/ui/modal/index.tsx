    ...
    <div className="fixed inset-0 flex items-start justify-center overflow-y-auto px-4 py-6 modal z-99999 sm:py-8">
      ...
      >
        {showCloseButton && (
          <button
            onClick={onClose}
            className="absolute right-3 top-3 z-999 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-400 transition-colors hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white sm:right-4 sm:top-4"
          >
            <svg
              width="20"
              height="20"
